...
import mob1s0480jpg from "../assets/images/banner/mobile/slide-img-1-0480.jpg";
import mob1s0480wpp from "../assets/images/banner/mobile/slide-img-1-0480.webp";
import mob1s0960jpg from "../assets/images/banner/mobile/slide-img-1-0960.jpg";
import mob1s0960wpp from "../assets/images/banner/mobile/slide-img-1-0960.webp";
...
import mob2s0480jpg from "../assets/images/banner/mobile/slide-img-2-0480.jpg";
import mob2s0480wpp from "../assets/images/banner/mobile/slide-img-2-0480.webp";
import mob2s0960jpg from "../assets/images/banner/mobile/slide-img-2-0960.jpg";
import mob2s0960wpp from "../assets/images/banner/mobile/slide-img-2-0960.webp";
import mob2s1440jpg from "../assets/images/banner/mobile/slide-img-2-1440.jpg";
import mob2s1440wpp from "../assets/images/banner/mobile/slide-img-2-1440.webp";
...
import mob3s0480jpg from "../assets/images/banner/mobile/slide-img-3-0480.jpg";
import mob3s0480wpp from "../assets/images/banner/mobile/slide-img-3-0480.webp";
import mob3s0960jpg from "../assets/images/banner/mobile/slide-img-3-0960.jpg";
import mob3s0960wpp from "../assets/images/banner/mobile/slide-img-3-0960.webp";
  ...
  slides: [
    {
      ...
      tabWEBP: `${tabWebp1}`,
      tabJPG: `${tabJpg1}`,
      tab1xJPG: `${tab1s0570jpg}`,
      tab1xWBP: `${tab1s0570wpp}`,
      tab2xJPG: `${tab1s1140jpg}`,
      tab2xWBP: `${tab1s1140wpp}`,
      tab3xJPG: `${tab1s1710jpg}`,
      tab3xWBP: `${tab1s1710wpp}`,
      tab4xJPG: `${tab1s2280jpg}`,
    ...
    },
    {
      mobWEBP: `${mobWebp2}`,
      mobJPG: `${mobJpg2}`,
      mob1xJPG: `${mob2s0480jpg}`,
      mob1xWBP: `${mob2s0480wpp}`,
      mob2xJPG: `${mob2s0960jpg}`,
      mob2xWBP: `${mob2s0960wpp}`,
      mob3xJPG: `${mob2s1440jpg}`,
      mob3xWBP: `${mob2s1440wpp}`,
      mob4xJPG: `${mob2s1920jpg}`,
